...
ICGC's "Access Controlled Data" documention can be found at [https://docs.icgc.org/portal/access/](https://docs.icgc.org/portal/access/){:target="_blank"}. To have access to controlled germline data, a DACO must be
