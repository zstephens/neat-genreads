#
#
#      Compute Fragment Length Model for gen_reads.python
#                  compute_fraglen.python
#
#
#      Usage: samtools view normal.bam | python compute_fraglen.python
#
#
...
def main():
    ...
    :return: None
    """
    parser = argparse.ArgumentParser(description="compute_fraglen.python")
